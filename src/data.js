const data = {
    "1": {
        "wsdl": {
            "outcomes": [
                ...
                "the most significant concept I learned through the lecture notes are SOAP Web Services, SOAP-based architecture, and WSDL wsdl wsdl wsdl"
            ],
            "challenges": [
        ...
        "soap": {
            ...
            "challenges": [
                ...
                "consuming SOAP web service, Apache CXF, Maven "
            ],
            "frequency": {
                "outcomes": 14,
                "challenges": 4
        ...
        "cxf": {
            "outcomes": [
                "Consuming a Web Service using CXF."
            ],
            "challenges": [
                "consuming SOAP web service, Apache CXF, Maven ",
                "Understanding the WSDL and UDDL concepts were challenging to understand for me. The external documents helped me to understand the concept of WSDL, but I was failed to follow the demo section (Consuming a Web Service using CXF slide). I did create a Maven project and added all dependencies and plugins in the pom.xml file just like the slides shows. However, when I load the Maven project, no source code is generated. I will research further on the \"cxf-codegen-plugin\" to fix my issue.",
                "The CXF and Maven slides were challenging as I have no experience using either."
            ],
            "frequency": {
                "outcomes": 1,
                "challenges": 3
        ...
        "service_oriented_architecture": {
            "outcomes": [
                "Service Oriented Architecture (SOA) is a new concept for me. The Web Services portion really helped me understand SOA as well.",
                "Learning about the structure of service oriented architecture"
            ],
            "challenges": [],
            "frequency": {
                "outcomes": 2,
        ...
        "eclipse": {
            "outcomes": [],
            "challenges": [
                "The Eclipse set up but that's just because I'm not a well versed as I should be due to being a C# developer."
            ],
            "frequency": {
                "outcomes": 0,
                "challenges": 1
    ...
    "2": {
        "javascript": {
            "outcomes": [
                ...
                "I had never heard of rest parameters in Javascript before! That is very interesting and can be very useful!",
        ...
        "variable": {
            "outcomes": [
                ...
                " I often have used JavaSript for developing the frontend, but I did not have a chance to look over the history of the language. The history section was interesting to me. Also, It is very interesting to know there is no official documentation about JavaScript. Also, I thought I know much about JavaScript features, but the lectures introduce features that I did not know before (such as setting the default value of a function, setting a function variable in an object, etc).",
                "The most interesting concept I learned about was destructing which allows for unpacking values into variables, it's a very handy trick."
            ],
            "challenges": [
                "I think the concepts discussed in this lecture such as objects and variables were pretty clear. Some of the difficult concepts I have a hard time understanding in JavaScript are Scope and Recursion. "
            ],
        ...
        "map": {
            ...
            "challenges": [
                "I don't use maps much so that part was a little confusing but not terribly so.",
                "Set and Map Collection"
            ],
            "frequency": {
                "outcomes": 1,
    ...
    "3": {
        ...
        "pattern": {
            "outcomes": [
                "I love the design for reuse section. At work, I've implemented multiple design patterns for the projects I work on that are centered around separation of concerns and reusability."
            ],
            "challenges": [],
            "frequency": {
                "outcomes": 1,
    ...
    "4": {
        "git": {
            "outcomes": [
                "Git",
                "Used GIT before but after watching the lecture diagrams the concept is very clear.",
        ...
        "cascade_pattern": {
            "outcomes": [
                "When Cascade Pattern as mentioned, I was unaware of this concept. I still need to look more into it."
            ],
            "challenges": [
                "Since the Cascade Pattern is a new concept, it is also the one more challenging. Once I get familiar with it, I should have a better understanding of it."
            ],
            "frequency": {
                "outcomes": 1,
                "challenges": 1
    ...
    "5": {
        ...
        "asynchronous_operation": {
            "outcomes": [
                "Great to see examples of each design approach. The most interesting part was the Asynchronous operation types (one-way and notification) and class activities."
            ],
            "challenges": [],
            "frequency": {
                "outcomes": 1,
